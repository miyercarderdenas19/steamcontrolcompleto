...
from tkinter import ttk, Menu, LabelFrame, Button, Entry, messagebox, Toplevel
...
class Producto():
    ...
    def __init__(self, ventana_producto):
        ...
        self.boton_registrar=Productos.add_button(label="Registrar",command= self.widgets_crud,image=self.img_registrar,compound=LEFT)
        self.boton_buscar=Productos.add_button(label="Buscar",command=self.widgets_buscador,image=self.img_buscar,compound=LEFT)
        self.boton_informacion=Productos.add_button(label="Informacion del sistema",command=self.widgets_informacion,image=self.img_informacion,compound=LEFT)
    ...
    def widgets_crud(self):
        ...
        #Logo arduino
        imagen_prisma=Image.open("c:/imagenes/prismaLOGO.png")
        nueva_imagen=imagen_prisma.resize((60,60))
        ...
        #Logo nodemcu
        imagen_SAMSON=Image.open("c:/imagenes/SAMSONLOGO.png")
        nueva_imagen=imagen_SAMSON.resize((60,60))
        render=ImageTk.PhotoImage(nueva_imagen)
        label_imagen= Label(self.frame_logo_productos, image= render)
        label_imagen.image=render
        ...
        #Logo raspberry
        imagen_tlv=Image.open("c:/imagenes/tlvLOGOpng")
        nueva_imagen=imagen_tlv.resize((60,60))
        render=ImageTk.PhotoImage(nueva_imagen)
        label_imagen= Label(self.frame_logo_productos, image= render)
        label_imagen.image=render
        ...
        "--------------- Botones --------------------"
        self.boton_registrar=ttk.Button(ventana_producto, text="REGISTRAR", command=self.widgets_crud)
    ...
    def widgets_buscador(self):
        ...
        "--------------- Titulo --------------------"
        self.titulo_buscador= Label(self.Label_titulo_buscador, text="CONSULTA DE EQUIPOS",fg="black",font=("Comic Sans", 17,"bold"))
    ...
    def widgets_informacion(self):
        ...
        "--------------- Titulo --------------------"
        self.Label_titulo = Label(self.Label_informacion,text="STEAMCONTROL",fg="white",bg="black",font=("Comic Sans", 25,"bold"),padx=137,pady=20)
        self.Label_titulo.grid(row=0,column=0)

        "--------------- Logos imagenes--------------------"
        #Logo 
        imagen_arduino=Image.open("c:/imagenes/descarga.png")
